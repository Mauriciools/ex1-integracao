...
# Function to receive and update the file coming from the server
def receive_and_update_file():
...
# Function to send the updated file back to the server
def send_file_back():
...
# Receive file from server and update it
receive_and_update_file()

# Delay between updating file and sending back data to the server
time.sleep(1)

# Send updated file back to the server
send_file_back()
